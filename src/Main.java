    ...
    public static void AddingGoodsToTheWarehouse(ArrayList<Stock> stocks, ArrayList<Product> products) {
        while (true) {
            ...
            if (mainMenuItem == 1) {
                ...
                System.out.print("Ввод:");
                String shampooName = sc.next();
                System.out.println("2) Введите объём Шампуня");
                System.out.print("Ввод:");
                int shampooVolume = sc.nextInt();
                products.get(0);
                ...
                System.out.print("Ввод:");
                String soapName = sc.next();
                System.out.println("    2) Введите вес Мыла");
                System.out.print("Ввод:");
                int soapWeight = sc.nextInt();
                products.get(1);
                ...
                System.out.print("Ввод:");
                int drinkVolume = sc.nextInt();
                products.get(2);
                System.out.println(products.get(2).toString());
                break;
            } else if (mainMenuItem == 0) {
                System.out.println("-------------------------------------------------------------");
                System.out.println("Выход в предыдущее меню...");
